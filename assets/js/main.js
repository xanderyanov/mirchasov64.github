...
$(function () {
  ...
  $('.form1').on('click', '.submit1', function (e) {
    ...
    if (name === '') {
        ...
        setTimeout(function(){$('.message1').removeClass('error');},3000);
    }
    else if (workemail !== '') {
...
if ($(".map__area").length) {
  ...
  function init() {
    ...
    myGeoObjects[0] = new ymaps.Placemark([mapCoordX,mapCoordY], {

      balloonContentHeader: '<div class="baloon__top">' + mapBaloonTop + '</div>' +
      '<div class="baloon__description">' + mapBaloonDesc + '</div>',
